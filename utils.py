...
class Definition(object):
    ...
    def toJSON(self):
        ...
        return {
            ...
            'relatedWords': [related_word.toJSON() for \
			related_word in self.related_words] if self.related_words else [],
...
class RelatedWord(object):
    ...
    def toJSON(self):
        ...
        '''
        return {
            'relationshipType':self.relationship_type if self.relationship_type else '',
